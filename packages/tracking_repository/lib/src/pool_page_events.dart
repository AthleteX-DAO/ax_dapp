...
class PoolPageUserEvent extends TrackEvent {
  ...
  PoolPageUserEvent.onApprovePoolClick(
    Map<String, dynamic> params,
          ...
          name: 'add_liquidity_approve_button_click',
          params: params,
        );
  ...
  PoolPageUserEvent.onConfirmPoolClick(
    Map<String, dynamic> params,
          ...
          name: 'add_liquidity_confirm_button_click',
          params: params,
        );
  ...
  PoolPageUserEvent.onRemoveApproveClick(
    Map<String, dynamic> params,
          ...
          name: 'remove_liquidity_approve_button_click',
          params: params,
        );
  ...
  PoolPageUserEvent.onRemoveConfirmClick(
    Map<String, dynamic> params,
          ...
          name: 'remove_liquidity_confirm_button_click',
          params: params,
        );
