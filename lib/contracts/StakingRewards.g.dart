...
/// like the gas price, nonce and max gas. The `data` and `to` fields will be
/// set by the contract.
Future<String> nominateNewOwner(_i1.EthereumAddress _owner, {required _i1.Credentials credentials, _i1.Transaction? transaction}) async  { final function = self.function('nominateNewOwner');
final params = [_owner];
return  write(credentials, transaction, function, params); } 
/// The optional [atBlock] parameter can be used to view historical data. When
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i1.EthereumAddress> nominatedOwner({_i1.BlockNum? atBlock}) async  { final function = self.function('nominatedOwner');
final params = [];
final response =  await read(function, params, atBlock);
return  (response  [
0
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i1.EthereumAddress> owner({_i1.BlockNum? atBlock}) async  { final function = self.function('owner');
final params = [];
final response =  await read(function, params, atBlock);
return  (response  [
0
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> rewards(_i1.EthereumAddress account, {_i1.BlockNum? atBlock}) async  { final function = self.function('rewards');
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> rewardsDuration({_i1.BlockNum? atBlock}) async  { final function = self.function('rewardsDuration');
final params = [];
final response =  await read(function, params, atBlock);
return  (response  [
0
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> userRewardPerTokenPaid(_i1.EthereumAddress account, {_i1.BlockNum? atBlock}) async  { final function = self.function('userRewardPerTokenPaid');
final params = [account];
final response =  await read(function, params, atBlock);
return  (response  [
0
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> getRewardForDuration({_i1.BlockNum? atBlock}) async  { final function = self.function('getRewardForDuration');
final params = [];
final response =  await read(function, params, atBlock);
return  (response  [
0
...
/// like the gas price, nonce and max gas. The `data` and `to` fields will be
/// set by the contract.
Future<String> notifyRewardAmount(BigInt reward, BigInt duration, {required _i1.Credentials credentials, _i1.Transaction? transaction}) async  { final function = self.function('notifyRewardAmount');
final params = [reward, duration];
return  write(credentials, transaction, function, params); } 
/// The optional [transaction] parameter can be used to override parameters
/// like the gas price, nonce and max gas. The `data` and `to` fields will be
/// set by the contract.
Future<String> updatePeriodFinish(BigInt timestamp, {required _i1.Credentials credentials, _i1.Transaction? transaction}) async  { final function = self.function('updatePeriodFinish');
final params = [timestamp];
return  write(credentials, transaction, function, params); } 
/// The optional [transaction] parameter can be used to override parameters
/// like the gas price, nonce and max gas. The `data` and `to` fields will be
/// set by the contract.
Future<String> recoverERC20(_i1.EthereumAddress tokenAddress, BigInt tokenAmount, {required _i1.Credentials credentials, _i1.Transaction? transaction}) async  { final function = self.function('recoverERC20');
final params = [tokenAddress, tokenAmount];
return  write(credentials, transaction, function, params); } 
/// The optional [transaction] parameter can be used to override parameters
/// like the gas price, nonce and max gas. The `data` and `to` fields will be
/// set by the contract.
Future<String> setRewardsDuration(BigInt _rewardsDuration, {required _i1.Credentials credentials, _i1.Transaction? transaction}) async  { final function = self.function('setRewardsDuration');
final params = [_rewardsDuration];
return  write(credentials, transaction, function, params); } 
/// Returns a live stream of all OwnerChanged events emitted by this contract.
Stream<OwnerChanged> ownerChangedEvents({_i1.BlockNum? fromBlock, _i1.BlockNum? toBlock}) { final event = self.event('OwnerChanged');
...
Stream<OwnerNominated> ownerNominatedEvents({_i1.BlockNum? fromBlock, _i1.BlockNum? toBlock}) { final event = self.event('OwnerNominated');
final filter = _i1.FilterOptions.events(contract: self, event: event, fromBlock: fromBlock, toBlock: toBlock);
return  client.events(filter).map((_i1.FilterEvent result) { final decoded = event.decodeResults(result.topics!, result.data!);
return  OwnerNominated(decoded); } ); } 
/// Returns a live stream of all Recovered events emitted by this contract.
Stream<Recovered> recoveredEvents({_i1.BlockNum? fromBlock, _i1.BlockNum? toBlock}) { final event = self.event('Recovered');
final filter = _i1.FilterOptions.events(contract: self, event: event, fromBlock: fromBlock, toBlock: toBlock);
return  client.events(filter).map((_i1.FilterEvent result) { final decoded = event.decodeResults(result.topics!, result.data!);
...
Stream<RewardsDurationUpdated> rewardsDurationUpdatedEvents({_i1.BlockNum? fromBlock, _i1.BlockNum? toBlock}) { final event = self.event('RewardsDurationUpdated');
final filter = _i1.FilterOptions.events(contract: self, event: event, fromBlock: fromBlock, toBlock: toBlock);
return  client.events(filter).map((_i1.FilterEvent result) { final decoded = event.decodeResults(result.topics!, result.data!);
...
class OwnerChanged {OwnerChanged(List<dynamic> response) : oldOwner = (response[0] as _i1.EthereumAddress), newOwner = (response[1] as _i1.EthereumAddress);
...
class OwnerNominated {OwnerNominated(List<dynamic> response) : newOwner = (response[0] as _i1.EthereumAddress);

final _i1.EthereumAddress newOwner;

 }
class Recovered {Recovered(List<dynamic> response) : token = (response[0] as _i1.EthereumAddress), amount = (response[1] as BigInt);
...
class RewardAdded {RewardAdded(List<dynamic> response) : reward = (response[0] as BigInt);
...
class RewardsDurationUpdated {RewardsDurationUpdated(List<dynamic> response) : newDuration = (response[0] as BigInt);
