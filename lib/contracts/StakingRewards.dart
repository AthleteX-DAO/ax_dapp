...
class StakingRewards extends _i1.GeneratedContract {
  ...
  Future<String> stake(BigInt amount, {required _i1.Credentials credentials}) {
    final _i1.EthereumAddress tokenAddr = _i1.EthereumAddress.fromHex(
        '0x585E0c93F73C520ca6513fc03f450dAea3D4b493');
    final athleteX = AthleteX(address: tokenAddr, client: client);
    final _i1.EthereumAddress stakingAddr =
    _i1.EthereumAddress.fromHex("0x063086C5b352F986718Db9383c894Be9Cd4350fA");
    athleteX.approve(stakingAddr, amount, credentials: credentials);
