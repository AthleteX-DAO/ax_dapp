    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Stack(
          ...
          children: [
            if (widget.state.status == BlocStatus.loading) const Loader(),
            if (widget.state.status == BlocStatus.error)
              const ScoutLoadingError(),
            if (widget.state.status == BlocStatus.noData)
              FilterMenuError(
                selectedChain: _selectedChain,
              ),
            if (widget.state.status == BlocStatus.success &&
                      ...
                      onPressed: () {
                        ...
                        setState(
                          () {
                            ...
                            selectedAthlete =
                                filteredAthletes[index].id.toString() +
                                      ...
                                      showDialog<void>(
                                        ...
                                        builder: (
                                          ...
                                          child: BuyDialog(
                                            ...
                                            athleteName:
                                                filteredAthletes[index].name,
                                            aptPrice: filteredAthletes[index]
                                                .longTokenBookPrice!,
                                            athleteId:
                                                filteredAthletes[index].id,
