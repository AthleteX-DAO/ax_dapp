...
class AthleteProfile extends StatefulWidget {
  AthleteProfile() : super();

  // Setting title for the action bar.
  final String title = 'Latest Sports News Feed';

  @override
  AthleteProfileState createState() => AthleteProfileState();
}

class AthleteProfileState extends State<AthleteProfile> {
  ...
  String _title = 'Athlete Performace'; // Place holder for appbar title.
