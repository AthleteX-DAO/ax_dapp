...
class AccountRepository {
  ...
  Future<void> transerTokens({
    ...
    final to = EthereumAddressValidator.parse(toAddress);
    final address = EthereumAddressValidator.parse(tokenAddress);
  ...
  Future<void> waitForReceipt(String txHash) =>
      _synthetixCoreService.waitForReceipt(txHash);
