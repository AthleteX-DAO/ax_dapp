...
class SwapApproveButton extends StatefulWidget {
  ...
  final SwapPageBloc swapPageBloc;

  @override
  State<SwapApproveButton> createState() => _SwapApproveButtonState();
}

class _SwapApproveButtonState extends State<SwapApproveButton> {
  String text = '';
              ...
              if (isApproved) {
                ...
                widget.confirmCallback().then((value) {
                  ...
                  showDialog<void>(
                    ...
                    setState(() {
                      resetButton();
                      widget.swapPageBloc.add(FetchSwapInfoRequested());
