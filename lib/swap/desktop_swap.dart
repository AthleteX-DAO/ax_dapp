...
class DesktopSwap extends StatefulWidget {
  const DesktopSwap({super.key});

  @override
  State<DesktopSwap> createState() => _DesktopSwapState();
}

class _DesktopSwapState extends State<DesktopSwap> {
  bool isWeb = true;
    ...
    return BlocListener<WalletBloc, WalletState>(
      listener: (context, state) {
        if (state.isWalletConnected || state.isWalletDisconnected) {
          context.read<SwapPageBloc>().add(WatchAppDataChangesStarted());
      ...
      child: BlocConsumer<SwapPageBloc, SwapPageState>(
        ...
        builder: (context, state) {
          ...
          void addEventForFromInputValue(String value, SwapPageBloc bloc) {
