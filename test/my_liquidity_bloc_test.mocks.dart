...
import 'package:ax_dapp/service/blockchain_models/liquidity_position.dart'
    as _i9;
import 'package:ethereum_api/tokens_api.dart' as _i5;
...
class MockGetAllLiquidityInfoUseCase extends _i1.Mock
  ...
  @override
  _i7.Future<_i2.Either<_i6.Success, _i8.SubgraphError>>
      fetchAllLiquidityPositions({required String? walletAddress}) =>
          (super.noSuchMethod(
            Invocation.method(
              #fetchAllLiquidityPositions,
              [],
              {#walletAddress: walletAddress},
            ),
            returnValue:
                _i7.Future<_i2.Either<_i6.Success, _i8.SubgraphError>>.value(
...
class MockWalletRepository extends _i1.Mock implements _i10.WalletRepository {
  ...
  @override
  _i5.EthereumChain get defaultChain => (super.noSuchMethod(
        Invocation.getter(#defaultChain),
        returnValue: _i5.EthereumChain.none,
      ) as _i5.EthereumChain);

  @override
  _i7.Stream<_i5.EthereumChain> get chainChanges => (super.noSuchMethod(
        Invocation.getter(#chainChanges),
        returnValue: _i7.Stream<_i5.EthereumChain>.empty(),
      ) as _i7.Stream<_i5.EthereumChain>);

  @override
  _i5.EthereumChain get currentChain => (super.noSuchMethod(
        Invocation.getter(#currentChain),
        returnValue: _i5.EthereumChain.none,
      ) as _i5.EthereumChain);
  ...
  _i7.Stream<_i4.Wallet> get walletChanges => (super.noSuchMethod(
        ...
        returnValue: _i7.Stream<_i4.Wallet>.empty(),
      ) as _i7.Stream<_i4.Wallet>);
  ...
  _i5.WalletCredentials get credentials => (super.noSuchMethod(
        ...
        returnValue: _FakeWalletCredentials_3(
          this,
          Invocation.getter(#credentials),
        ),
  ...
  @override
  _i7.Future<bool?> searchForWallet() => (super.noSuchMethod(
        Invocation.method(
          #searchForWallet,
          [],
        ),
  ...
  @override
  _i7.Future<String> createWallet() => (super.noSuchMethod(
        Invocation.method(
          #createWallet,
          [],
        ),
  ...
  @override
  _i7.Future<String> importWallet(String? hex) => (super.noSuchMethod(
        Invocation.method(
          #importWallet,
          [hex],
        ),
  ...
  @override
  _i7.Future<String> connectWallet() => (super.noSuchMethod(
        Invocation.method(
          #connectWallet,
          [],
        ),
  ...
  @override
  _i7.Future<void> disconnectWallet() => (super.noSuchMethod(
        Invocation.method(
          #disconnectWallet,
          [],
        ),
  ...
  @override
  _i7.Future<BigInt> getRawTokenBalance(String? tokenAddress) =>
      (super.noSuchMethod(
        Invocation.method(
          #getRawTokenBalance,
          [tokenAddress],
        ),
        returnValue: _i7.Future<BigInt>.value(_i11.dummyValue<BigInt>(
          this,
          Invocation.method(
            #getRawTokenBalance,
            [tokenAddress],
  ...
  @override
  _i7.Future<BigInt> getDecimals(String? tokenAddress) => (super.noSuchMethod(
        Invocation.method(
          #getDecimals,
          [tokenAddress],
        ),
  ...
  @override
  _i7.Future<double> getGasPrice() => (super.noSuchMethod(
        Invocation.method(
          #getGasPrice,
          [],
        ),
...
class MockStreamAppDataChangesUseCase extends _i1.Mock
    implements _i12.StreamAppDataChangesUseCase {
  MockStreamAppDataChangesUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Stream<_i13.AppData> get appDataChanges => (super.noSuchMethod(
        Invocation.getter(#appDataChanges),
        returnValue: _i7.Stream<_i13.AppData>.empty(),
      ) as _i7.Stream<_i13.AppData>);
}
